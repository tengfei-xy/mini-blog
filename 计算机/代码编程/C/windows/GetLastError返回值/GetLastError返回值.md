...
| 5078  | 找不到指定的资源种类。                                                                             |
| 5079  | 指定的节点不支持这种资源，这也许是由于版本不一致或是由于在这个节点上没有资源                                                  |
| 5080  | 该资源                                                                                     |
| 5081  | 不能在                                                                                     |
...
| 5311  | 网络控制块                                                                                   |
| 5312  | 网络控制块                                                                                   |
| 5313  | 该名称已经存在于本地适配器名称表中。                                                                      |
| 5314  | 网卡名称表已满。                                                                                |
| 5315  | 网络名称已经有活动的会话，现在取消注册。                                                                    |
| 5316  | 先前发出的                                                                                   |
| 5317  | 本地会话表已满。网络控制块                                                                           |
| 5318  | 拒绝打开网络控制块                                                                               |
| 5319  | 网络控制块                                                                                   |
...
| 5600  | 无法共享用户或脚本路径。                                                                            |
| 5601  | 计算机的密码在本地安全                                                                             |
| 5602  | 访问计算机的本地或网络安全数据库时，                                                                      |
| 5705  | Netlogon                                                                                |
| 5728  | 无法加载任何传输。                                                                               |
| 5739  | 此域的全局组数目超过可以复制到                                                                         |
| 5742  | 服务无法检索必要的消息，所以无法运行远程启动客户。                                                               |
| 5743  | 服务发生严重的错误，无法从远程启动                                                                       |
| 5744  | 服务发生严重的系统错误，即将关机。                                                                       |
| 5760  | 服务在分析                                                                                   |
| 5761  | 服务在创建所有配置的                                                                              |
| 5762  | 服务在访问注册表时出错。                                                                            |
| 5763  | 服务在替换可能过期的                                                                              |
| 5764  | 服务在添加安全帐户或设置文件权限时出错。                                                                    |
| 5765  | 服务无法备份它的数据库。                                                                            |
| 5766  | 服务无法从它的数据库初始化。                                                                          |
| 5767  | 服务无法从备份数据库还原它的数据库。服务                                                                    |
| 5768  | 服务无法从备份数据库还原它的数据库。                                                                      |
| 5769  | 服务无法从它还原的数据库初始化。服务                                                                      |
| 5771  | 远程启动数据库采用                                                                               |
| 5773  | 该                                                                                       |
| 5781  | 由于没有可以使用的                                                                               |
| 6000  | 无法加密指定的文件。                                                                              |
...
| 7052  | 拒绝连接到这个终端服务器。终端服务器客户许可证目前正在被另一个用户使用。                                                    |
| 7053  | 拒绝连接到这个终端服务器。还没有为这份终端服务器客户输入您的终端服务器客户许可证号码。                                             |
| 7054  | 系统已达到其授权的登录限制。                                                                          |
...
| 8005  | 该文件复制服务中断了该请求。                                                                          |
| 8006  | 无法联系文件复制服务。                                                                             |
| 8007  | 由于该用户没有足够特权，文件复制服务不能满足该请求。                                                              |
| 8008  | 由于验证的                                                                                   |
| 8009  | 由于该用户在域控制器上没有足够特权，文件复制服务不能满足该请求。                                                        |
| 8010  | 由于在域控制器上的验证的                                                                            |
| 8011  | 该文件复制服务无法与在域控制器上的文件复制服务通讯。                                                              |
| 8012  | 在域控制器上的文件复制服务无法与这台计算机上的文件复制服务通讯。                                                        |
| 8013  | 由于内部错误，该文件复制服务不能进入该系统卷中。                                                                |
| 8014  | 由于内部超时，该文件复制服务不能进入该系统卷中。                                                                |
| 8015  | 该文件复制服务无法处理此请求。该系统卷仍在忙于前一个请求。                                                           |
| 8016  | 由于内部错误，该文件复制服务无法停止复制该系统卷。                                                               |
...
| 8488  | 跨域移动的来源和目标提供的来源对象的身份不一样。                                                                |
| 8489  | 跨域移动的对象应该已经被目标服务器删除。来源服务器没有来源对象的最近版本。                                                   |
| 8490  | 要求对                                                                                     |
| 8491  | 跨域移动没有成功，导致被移动对象有两个版本                                                                   |
...
| 8507  | 试图修改基础架构。                                                                               |
| 8508  | 不允许进行下列操作:                                                                              |
| 8509  | 该域控制器上不允许架构更新。没有设置注册表项，或者                                                               |
...
| 8522  | 架构缓冲加载未能转换类架构对象上的字符串默认值                                                                 |
| 8523  | 只有配置成全局编录服务器的                                                                           |
| 8524  | 由于                                                                                      |
| 8525  | 处理一个对象的                                                                                 |
| 8526  | 未能读取安全描述符属性。                                                                            |
| 8527  | 没有找到请求的对象，但找到了具有那个密钥的对象。                                                                |
| 8528  | 正在添加的链接属性的语法不正确。正向链接只能有语法                                                               |
...
| 10109 | 找不到指定的类别。                                                                               |
| 10110 | WSALookupServiceNext                                                                    |
| 10111 | 在处理这个调用时，就开始调用                                                                          |
| 10112 | 由于被拒绝，数据查询失败。                                                                           |
