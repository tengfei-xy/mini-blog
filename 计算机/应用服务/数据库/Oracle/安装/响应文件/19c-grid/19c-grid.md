...
#-------------------------------------------------------------------------------
oracle.install.crs.config.gpnp.scanName=oracle-scan
...
#
#-------------------------------------------------------------------------------
oracle.install.crs.config.networkInterfaceList=ens192:73.0.0.0:1,ens224:73.96.0.96:5,virbr0:192.168.122.0:3
...
#
#-------------------------------------------------------------------------------
oracle.install.asm.diskGroup.disksWithFailureGroupNames=/dev/ASM-OCR1,,/dev/ASM-OCR2,,/dev/ASM-OCR3,
...
#
#-------------------------------------------------------------------------------
oracle.install.asm.diskGroup.disks=/dev/ASM-OCR1,/dev/ASM-OCR2,/dev/ASM-OCR3
