...
floppya: 1_44="/home/tengfei/melta/boot.img", status=inserted, write_protected=0
...
cpuid: x86_64=1,level=6, mmx=1, sep=1, aes=1, movbe=1, xsave=1,apic=x2apic,sha=1,movbe=1,adx=1,xsaveopt=1,avx_f16c=1,avx_fma=1,bmi=bmi24,1g_pages=1,pcid=1,fsgsbase=1,smep=1,smap=1,mwait=1,vmx=1
